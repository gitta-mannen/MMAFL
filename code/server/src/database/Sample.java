	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		try {
			...
			connection = DriverManager
					.getConnection("jdbc:sqlite:fightstats.db");
			...
			statement
					.executeUpdate("create table fighters (id integer, name string, nickname string)");
			...
			// scarpe loop
				...
				statement
						.executeUpdate("insert into fighters values(1, 'bertil', 'the nightmare')");
				statement
						.executeUpdate("insert into fighters values(2, 'rötivar', 'cripple')");
