...
//		String[] regexes = Settings.getNodeText("scrapers:completed-events:scrape-field:regex");
//		String page = util.IO.fileToString("E:\\projekt\\MMAFL\\code\\server\\www\\fm_c_events.htm");
//		String table= Scraper.findFirst(page, tableRegex);
//		System.out.println("table regex: " + tableRegex);
